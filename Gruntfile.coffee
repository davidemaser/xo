    ...
    grunt.initConfig
        ...
        jshint:
            ...
            globals:
                ...
                module: true
        uglify:
            options: banner: '/*! <%= pkg.name %> last updated <%= grunt.template.today("yyyy-mm-dd") %> by <%= pkg.author %> */\n'
            build:
        ...
        sass:
            options:
                ...
                sourceMap: false
            dist: files: 'skeleton/dist/css/<%= pkg.name %>.min.css': 'skeleton/scss/<%= pkg.name %>.scss'
        htmlmin:
            dist:
                options:
                    removeComments: true
                    collapseWhitespace: true
                files: 'skeleton/examples/dist/index.html': 'skeleton/examples/index.html'
            dev: files: 'skeleton/examples/dist/index.html': 'skeleton/examples/index.html'
        watch:
            scripts:
                files: 'skeleton/js/*.js'
                tasks: [
